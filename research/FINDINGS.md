...
are visually and textually separated from runtime evidence, and output clicks
produce native-coordinate feedback notes. This makes user observations executable
test cases rather than screenshots without provenance.
