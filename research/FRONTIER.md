...
| 2 | **Real N-frame optical data** (microscopy z-stacks: BBBC, Cell Image Library; light-field focal stacks) | Real optical defocus + many frames + high-res — closes the two standing validation gaps at once. | 🔶 B2 |
| 3 | **Occlusion-boundary physics (α-matte)** | Real depth edges mix fg/bg semi-transparently; our generator uses hard depth indexing and the fusion ignores matting. Leading-edge MFIF papers target exactly this. Generator honesty gates all synthetic conclusions. | 🔶 B3 |
