...
| 16c | **Reconstruction applicability gating** | Fire only where the matte model demonstrably holds: veil evidence (far-frame energy suppression at support), not mere focus dominance; then real-capture validation (#13) gates promotion. | ⬜ NEXT |
