...
| 3b | **Occlusion-AWARE scene recovery** | Joint layer inversion (de-veiling beyond camera-mix). | 🔶 F66 / SAFETY-DISABLED: focal-pair completion now defines the hard front, while the conservative cross-frame intersection independently licenses rear correction. Frozen S25: zero rear pixels in GT core/edge/far for 6/6; 6/6 MAE/MSE/core/veil wins and exact far identity; mean silhouette IoU 0.9647; 5/6 SSIM wins. The lone SSIM dissent has direct gains and no ownership violation. Generate fresh S26 next; inspector remains frozen until the end. |
