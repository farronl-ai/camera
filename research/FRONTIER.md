...
| 16e | **Semantic matte input** (unblocks 16d and improves 16b/16c) | Three arcs stalled on the same wall: the matte IS the frontier, and it is semantic. DA-V2 blob mattes (F31) via two-pass bridge feeding correct_veil/reconstruct; package keeps torch optional. | ⬜ NEXT |
