...
|---|---|
| F27: de-veiling by inversion loses | **CONDITIONALLY REOPENED / RESEARCH, AUTO DISABLED** (F62) — F60 replaced the invalid V1 judge; F61 added asymmetric rear visibility; F62 repairs focused-owner geometry/front pixels before rear inversion, repairs the S16 counterexample, then passes a genuinely post-final 72-scene S19 audit with 3/3 all-partition-positive fires and 69 exact refusals. The model remains runtime-disabled until its reduced but still-positive fine-band false-texture tail is causally removed rather than averaged away |
