...
|---|---|
| F27: de-veiling by inversion loses | **CONDITIONALLY REOPENED / RESEARCH, AUTO DISABLED** (F66) — F60 replaced the invalid V1 judge; F61/F62 established asymmetric rear visibility and front-first geometry; F63 split formation regimes; F64 made confidence local; F65 corrected primary opaque formation. F66 separates completed hard-front geometry from conservative rear permission. Frozen S25 has zero rear-mask overlap with GT core, antialiased edge, and far background in 6/6, plus 6/6 MAE/MSE/core/veil gains and exact far identity (5/6 SSIM). The S23 inspector and shipping auto path stay preserved/disabled until fresh S26 passes and the final inspector is generated once. |
