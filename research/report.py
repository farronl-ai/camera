...
<div class="wrap">
  ...
  <table><thead><tr><th>milestone</th><th>outcome</th></tr></thead><tbody>
    ...
    <tr><td>One-sided joint giant-veil recovery</td><td><b>Narrowly shipped.</b> V2 guarantees zero rear throughput in hard ownership; discrete focused-owner graphs separate opaque support from rear openings and mask speckle. Frozen post-rule S29 licenses 11/refuses one; every fire improves MAE/MSE and all physical partitions with exact far identity. (F69&ndash;F76)</td></tr>
    <tr><td><code>--enhance auto</code> shipped</td><td>Gated contour reconstruction remains live. Exactly two-frame, validated-size giant-veil recovery now launches the semantic bridge and fires only after cross-frame ownership, focal ordering, forward-fit, and six-model stability checks. Every failed gate is byte-identical. (F48/F76)</td></tr>
